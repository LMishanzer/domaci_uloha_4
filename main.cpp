...
//    ostringstream os;
//    CBank bank;
//    bank.NewAccount("sdkfjskldjd", 100);
//    bank.NewAccount("sdkfjskldjd1", 200);
//    os << bank.Account("sdkfjskldjd");
//
//    bank.Transaction("sdkfjskldjd", "sdkfjskldjd1", 100, "dsjfjfljfl");
//    os << bank.Account("sdkfjskldjd");
//
//    bank.Transaction("sdkfjskldjd", "sdkfjskldjd", 100, "dsjfjfljfl");
//    os << bank.Account("sdkfjskldjd1");
//    cout << os.str();
